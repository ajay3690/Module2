...
\begin{figure}[H]
    \centering
    \includegraphics{/sdcard/digital-design/geometry/figs/AD.png}
    \caption{Line AD}
    \label{fig:line_ad}
\end{figure}
...
\item Find the equations of the altitudes $BE_1$ and $CF_1$ to the sides $AC$ and $AB$ respectively. 
 ...
 \end{align}
  ...
  \begin{figure}[H]
      \centering
      \includegraphics{/sdcard/digital-design/geometry/figs/BECF.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{/sdcard/digital-design/geometry/figs/BECF.png}
...
\begin{figure}
    \centering
    \includegraphics{/sdcard/digital-design/geometry/figs/ABCH.png}
