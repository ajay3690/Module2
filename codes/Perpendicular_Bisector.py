...
sys.path.insert(0, '/sdcard/digital-design/geometry/codes/CoordGeo')        #path to my scripts
import numpy as np
import mpmath as mp
...
tri_coords = np.block([[A,B,C,O,G]])
plt.scatter(tri_coords[0,:], tri_coords[1,:])
vert_labels = ['A','B','C','O','G']
...
#if using termux
plt.savefig('/sdcard/digital-design/figs/pictoG1')
